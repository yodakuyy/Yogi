...
export const Dashboard: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#F3F4F8] flex font-sans text-gray-800">
      ...
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col fixed h-full z-10">
        ...
        <nav className="flex-1 px-4 space-y-1">
          ...
          <NavItem icon={<Ticket size={18} />} label="Tickets" badge="39" />
      ...
      <main className="flex-1 ml-64 p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          {/* Inventory Management (Bottom Right) */}
...
const NavItem: React.FC<{ icon: React.ReactNode; label: string; active?: boolean; badge?: string }> = ({ icon, label, active, badge }) => (
  <a href="#" className={`flex items-center justify-between px-3 py-3 rounded-lg text-sm font-medium transition-colors ${active ? 'bg-[#E0E7FF] text-[#4F46E5]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}>
