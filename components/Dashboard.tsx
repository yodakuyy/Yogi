  ...
  return (
    <div className="min-h-screen bg-[#F3F4F8] flex font-sans text-gray-800 relative overflow-hidden">
      ...
      >
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar">
          ...
          <div>
            <button 
                ...
                className={`w-full flex items-center justify-between px-3 py-3 rounded-lg text-sm font-medium transition-colors text-gray-600 hover:bg-gray-50 hover:text-gray-900`}
            >
                <div className="flex items-center gap-3">
                <Settings size={18} />
                <span>Settings</span>
                </div>
                <ChevronDown size={14} className={`transition-transform duration-200 text-gray-400 ${isSettingsOpen ? 'rotate-180' : ''}`} />
            </button>
            
            {/* Submenu */}
            {isSettingsOpen && (
                <div className="pl-11 space-y-1 mt-1 mb-2 animate-in slide-in-from-top-2 duration-200">
                    <SubNavItem label="User Management" />
                    <SubNavItem label="Group Management" />
                    <SubNavItem label="SLA Management" />
                    <SubNavItem label="Business Hours" />
                    <SubNavItem label="Categories" />
                    <SubNavItem label="Service Request Fields" />
                </div>
            )}
          </div>
        </nav>
        ...
        <div className="p-4 border-t border-gray-100 flex items-center justify-between relative bg-white z-10">
          <div className="flex items-center space-x-3">
...
const SubNavItem: React.FC<{ label: string }> = ({ label }) => (
    <button className="w-full text-left px-3 py-2 text-xs font-medium text-gray-500 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors">
        {label}
    </button>
);
