...
const tickets = [
  { 
    id: 'INC21238957', 
    title: 'Configuration Security Failed', 
...
export const IncidentList: React.FC = () => {
  ...
  const filteredTickets = tickets.filter(ticket => {
    ...
    const matchesSearch = 
        ...
        ticket.caller.toLowerCase().includes(query) ||
    ...
    if (filters.requester && !ticket.caller.toLowerCase().includes(filters.requester.toLowerCase())) return false;
                ...
                <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <div className="relative w-64">
                        ...
                        <input 
                            ...
                            className="w-full pl-9 pr-4 py-1.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 transition-colors" 
                        />
                    </div>
                </div>
